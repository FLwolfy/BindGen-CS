namespace BGCS
{
    ...
    public partial class CsCodeGeneratorConfig : IGeneratorConfig
    {
        ...
        /// <summary>
        /// Header files generated by <see cref="CsCodeGenerator.GenerateConfigured"/>. Relative paths are resolved from the configuration directory.
        /// </summary>
        [DefaultValue(null)]
        ...
        /// <summary>
        /// Default output directory used by <see cref="CsCodeGenerator.GenerateConfigured"/>. (Default: <c>Generated</c>)
        /// </summary>
